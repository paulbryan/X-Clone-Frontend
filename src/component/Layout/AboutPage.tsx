    ...
    return (
        ...
        <div className="flex w-full h-full gap-4 flex-col px-4">
            ...
            <div className="w-full gap-2 flex flex-col">
                ...
                <p className="text-(--text-main)">I chose to make a twitter/X clone due to it being a text-focused platform that also has a user friendly desktop version</p>
            </div>
            ...
            <div className="w-full gap-2 flex flex-col">
                ...
                <p className="text-(--text-main)">Apart from cleaning up the code, my current goals are to implement a more advanced and personalized feed. On the backend, i'd like to implement some kind of cache for this as well</p>
            </div>
