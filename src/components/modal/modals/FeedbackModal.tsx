    ...
    return (
      <div className="w-full h-full flex flex-col border text-twitterText rounded-4xl p-8 items-center gap-8 bg-(--background-main)">
        ...
        <div className="w-full flex flex-col justify-center gap-4">
            <p className="text-xl font-bold text-center">Submit feedback or bug</p>
        ...
        <div className="w-full flex flex-col justify-center gap-4">
            ...
            <div className="w-full flex gap-6 items-center justify-between">
                ...
                <div onClick={() => setClickedType("Bug")} className={`p-2 hover:bg-twitterTextAlt/20 hover:cursor-pointer w-full ${clickedtype == "Bug" ? "shadow-[0_0_5px_2px_orange] border-orange-300" : "border-twitterText"} rounded-2xl border `}>
                    <p className="text-center">Bug</p>
                </div>

                <div onClick={() => setClickedType("Feedback")} className={`hover:bg-twitterTextAlt/20 hover:cursor-pointer p-2 w-full rounded-2xl ${clickedtype == "Feedback" ? "shadow-[0_0_5px_2px_green] border-green-500" : "border-twitterText"} border`}>
        ...
        <div onClick={() => handleSubmit()} className={`py-3 w-2/3 ${textInput.length > 0 ? "hover:cursor-pointer border-(--color-main)" : "hover:cursor-not-allowed text-twitterText/30 border-(--color-main)/60"} hover:bg-twitterTextAlt/20 rounded-full justify-center flex border items-center`}>
