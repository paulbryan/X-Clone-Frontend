...
export function ComposePollExpiry ({pollExpiry, setPollExpiry}: ComposePollExpiryProps) {
    ...
    return (
        <div className="w-full flex gap-4 justify-between mb-4">
            <PollExpiryField choiceName="Days" timeLimit={7} setTime={setTimeForExpiry} selectedTime={pollExpiry[getExpiryTimeIndex("Days")]}/>
            <PollExpiryField choiceName="Hours" timeLimit={23} setTime={setTimeForExpiry} selectedTime={pollExpiry[getExpiryTimeIndex("Hours")]}/>
            <PollExpiryField choiceName="Minutes" timeLimit={59} setTime={setTimeForExpiry} selectedTime={pollExpiry[getExpiryTimeIndex("Minutes")]}/>
        </div>
    )
